...
# user1 = UserProfile.objects.filter(username='john_doe').get()
# user2 = UserProfile.objects.filter(username='jane_smith').get()
# user3 = UserProfile.objects.filter(username='alice').get()
...
# message1 = Message.objects.filter(id=3).get()
